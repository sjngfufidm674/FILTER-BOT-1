...
API_ID = int(environ.get('API_ID', '21649292'))
API_HASH = environ.get('API_HASH', 'c70e51bded5eafb207bfde2cb83d54a2')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7860475148').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002304251292'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002265747013') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002365180736')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '7860475148')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002256961267')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002433894210').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://izwa:vkgTR8JRPNYi3cw3@cluster0.e3cfb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 't.me/+TIHLzYMtAWw0MmVl')
CHNL_LNK = environ.get('CHNL_LNK', 't.me/+62ydLZZDrKFhZWFl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/+q_iFiPRNJtYxMWRl') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/izwa421')
